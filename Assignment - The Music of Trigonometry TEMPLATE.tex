...
\large{First Group Member:  %%%TYPE Name of First Group Member\\ 
}

\large{Second Group Member:  %%%TYPE Name of Second Group Member\\ 
}

\large{Third Group Member:  %%%TYPE Name of Third Group Member\\ 
}
\\
...
%%%%%Remove all percent signs below to activate enumeration and replace relevant text with your own.
%\begin{enumerate}
